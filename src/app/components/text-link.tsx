...
export default function TextLink({ d, cids, styles }: { d: TextLinkData; cids: string[]; styles: TextLinkStyles }) {
  return (
    <button data-cid={cids[0]} className="flex min-w-0 flex-col items-center flex-1 gap-4 [font-family:Arial] text-[0.8125rem] leading-[0.9375rem] text-center cursor-pointer max-lg:gap-[0.65rem]" data-component="button" aria-selected={d.ariaselected === "true"} role="tab" type="button">
