...
const ListRow2_data: ListRow2Data[] = [
    ...
    { text: "150K+", text2: "Messages automated" },
    { text: "4.1/5", text2: "Trustpilot" }
];
const Tile_data: TileData[] = [
    { text: "ZM.USERS", text2: "5,012", text3: "+12.4%" },
    { text: "ZM.MSGS", text2: "152,340", text3: "+8.2%" },
